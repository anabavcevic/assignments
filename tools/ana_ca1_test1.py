...
grid_param = {'n_estimators': [200, 300, 350, 400, 450]}
...
X = final_data[['PageValue', 'ExitRate', 'ProductRelated_Duration', 'ProductRelated', 'Administrative', 'Administrative_Duration', 'BounceRate', 'Month_Nov', 'Informational', 'Month_May']]
